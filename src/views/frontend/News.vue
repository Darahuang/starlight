        ...
        <div class="col-md-4">
          <div class="card mb-5">
            <div
              ...
              "
              class="bg-cover card-image cursor"
            ></div>
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card mb-5">
            <div
              style="
                height: 250px;
                background-image: url(https://images.pexels.com/photos/2072175/pexels-photo-2072175.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);
              "
              class="bg-cover card-image cursor"
            ></div>
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card mb-5">
            <div
              style="
                height: 250px;
                background-image: url(https://images.pexels.com/photos/1148572/pexels-photo-1148572.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);
              "
              class="bg-cover card-image cursor"
            ></div>
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card mb-5">
            <div
              style="
                height: 250px;
                background-image: url(https://images.unsplash.com/photo-1577046823799-58b2d217d508?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80);
              "
              class="bg-cover card-image cursor"
            ></div>
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card mb-5">
            <div
              style="
                height: 250px;
                background-image: url(https://images.unsplash.com/photo-1558231728-b4e138755840?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1273&q=80);
              "
              class="bg-cover card-image cursor"
            ></div>
            <div class="card-body">
